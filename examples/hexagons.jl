...
PCstar(6,2, G3stmts) #The cycle cannot be oriented
PCstar(G3, C3, 2)
PCstar(6, Csep_dict(G3,C3,2))


#example 4: two colliders 

G4 = DAG_from_edges([(6,5),(1,6),(1,2),(3,2),(3,4),(4,5)])
...
PCstar(6,2, G4stmts)
PCstar(G4,C4, 2)
PCstar(6, Csep_dict(G4,C4,2))


G5 = DAG_from_edges([(6,5),(1,6),(1,2),(3,2),(4,3),(4,5)])

#reversing the "middle edges" of the hexagon does not change the global Markov property. 
get_Csepstatements(G4) == get_Csepstatements(G5) #true